...
Console.WriteLine("Prime numbers using method Parallel.ForEach from 1 to " + n + ":");
...
Console.WriteLine("Prime numbers using method Task from 1 to " + m + ":");
...
Console.WriteLine("Prime numbers using method Thread from 1 to " + k + ":");
...
Console.WriteLine("Prime numbers using method The Sieve of Eratosthenes from 1 to " + l + ":");
